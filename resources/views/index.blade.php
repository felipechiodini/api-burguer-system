        ...
        <div class="container">
            <div class="heading_container heading_center ">
                ...
                <p class="col-lg-8 px-0">
                    No mundo em constante evolução,
                    é crucial ter as ferramentas certas à disposição para enfrentar os desafios modernos.
                    É aqui que entram as nossas soluções.
                </p>
            </div>
                        ...
                        <div class="item">
                            <div class="box ">
                                ...
                                <div class="detail-box">
                                    ...
                                    <p>
                                        Nosso sistema de gerenciamento abrange uma série de módulos essenciais,
                                        incluindo controle de estoque, frente de caixa, finanças e conformidade fiscal.
                                        Tudo isso é cuidadosamente organizado de maneira intuitiva.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="box ">
                                ...
                                <div class="detail-box">
                                    ...
                                    <p>
                                        Uma comodidade que os aplicativos de delivery proporcionam aos consumidores,
                                        é a possibilidade de escolher o seu pedido e qual estabelecimento irá lhe entregar em casa.
                                        Estar inserido nestes aplicativos hoje, é algo muito válido, seu estabelecimento pode se aproveitar
                                        destas oportunidades para agregar ainda mais na experiencia do cliente.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-5 mx-auto">
                    <div class="form_container">
                        ...
                        <form action="">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    <input type="text" class="message-box form-control" placeholder="Mensagem" />
                                </div>
                            </div>
                            <div class="btn_box">
                                <button>
